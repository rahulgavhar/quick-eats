...
const Checkout = () => {
  ...
  const { userData, cartItems, coords, city } = useSelector(
    (state) => state.user
  );
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${apiURL}/api/orders/create`, orderData, {
      ...
      if (paymentMethod === "COD") {
        ...
        openPaymentWindow(orderIds, razorpayOrder);
      }
    } catch (error) {
  ...
  const openPaymentWindow = (orderIds, razorpayOrder) => {
    const options = {
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className={`sticky top-0 z-2000 shadow-md transition-colors duration-300 ${
          mode === "dark"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              {/* Security Badge */}
              <div
                className={`mt-4 flex items-center gap-2 p-3 rounded-lg transition-colors duration-300 ${
          ...
          <div className="lg:col-span-1">
            <div
              className={`rounded-xl shadow-lg p-6 sticky top-24 transition-colors duration-300 ${
                mode === "dark" ? "bg-gray-800" : "bg-white"
              }`}
            >
              <h2
              ...
              {/* Price Breakdown */}
              <div
                className={`border-t border-b py-4 space-y-3 transition-colors duration-300 ${
                  mode === "dark"
              ...
              {/* Total */}
              <div
                className={`flex justify-between items-center mt-4 mb-6 transition-colors duration-300 ${
                  mode === "dark" ? "text-white" : "text-gray-900"
                }`}
              >
              ...
              {/* Trust Indicators */}
              <div
                className={`mt-4 pt-4 border-t space-y-2 transition-colors duration-300 ${
                  mode === "dark" ? "border-gray-700" : "border-gray-200"
                }`}
              >
