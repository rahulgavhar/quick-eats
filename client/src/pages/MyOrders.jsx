  ...
  if (loading) {
    return (
      <div className={`min-h-screen transition-colors duration-300 ${
        ...
        <div className={`sticky top-0 z-10 shadow-md transition-colors duration-300 ${
      ...
      <div className={`sticky top-0 z-10 shadow-md transition-colors duration-300 ${
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className={`text-lg font-semibold px-4 py-2 rounded-full transition-colors duration-300 ${
          ...
          {error && (
            <div className={`mb-4 p-4 rounded-lg flex items-center gap-2 transition-colors duration-300 ${
              mode === 'dark' ? 'bg-red-900/30 text-red-400 border border-red-800' : 'bg-red-50 text-red-700 border border-red-200'
            }`}>
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-center">
                    ...
                    <div>
                      ...
                      <p className={`font-mono text-sm font-bold transition-colors duration-300 ${
                    ...
                    <div>
                      ...
                      <p className={`text-2xl font-bold transition-colors duration-300 ${
                        ...
                        {order.orders.reduce((sum, restaurantOrder) => 
                          sum + restaurantOrder.items.length, 0
                        )}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      {isOwner ? (
                        ...
                        <div className={`inline-flex items-center gap-1 px-3 py-1 rounded-full border font-semibold text-sm mt-1 transition-colors duration-300 ${
                ...
                {expandedOrder === order._id && (
                  <div className={`border-t transition-colors duration-300 ${
                    ...
                    <div className={`p-6 border-b transition-colors duration-300 ${
                      mode === 'dark' ? 'border-gray-700 bg-gray-700/30' : 'border-gray-200 bg-gray-50'
                    }`}>
                      <h3 className={`font-bold mb-2 flex items-center gap-2 transition-colors duration-300 ${
                        mode === 'dark' ? 'text-white' : 'text-gray-900'
                      }`}>
                      ...
                      <p className={`text-sm mt-1 transition-colors duration-300 ${
                        ...
                        📍 {order.deliveryAddress.coordinates.lat.toFixed(4)}, {order.deliveryAddress.coordinates.lon.toFixed(4)}
                      </p>
                    </div>
                    ...
                    <div className={`p-6 border-b transition-colors duration-300 ${
                      ...
                      <div className="space-y-4">
                        {order.orders.map((restaurantOrder, idx) => (
                          <div key={idx} className={`rounded-lg p-4 transition-colors duration-300 ${
                            mode === 'dark' ? 'bg-gray-700' : 'bg-gray-100'
                          }`}>
                            <h4 className={`font-bold mb-3 transition-colors duration-300 ${
                              mode === 'dark' ? 'text-green-400' : 'text-green-600'
                            }`}>
                              {restaurantOrder.restaurantId?.name || 'Restaurant'}
                            </h4>
                            <div className="space-y-2 mb-3 border-b pb-3" style={{
                              borderColor: mode === 'dark' ? '#4b5563' : '#e5e7eb'
                            }}>
                              {restaurantOrder.items.map((item, itemIdx) => (
                                <div key={itemIdx} className="flex justify-between items-start">
                                  ...
                                  <p className={`font-semibold transition-colors duration-300 ${
                                    ...
                                    ${(item.itemId?.price * item.quantity).toFixed(2) || 'N/A'}
                                  </p>
                                </div>
                              ))}
                            </div>
                            <div className="flex justify-between items-center">
                              ...
                              <span className={`font-bold transition-colors duration-300 ${
                                ...
                                ${restaurantOrder.subTotal.toFixed(2)}
                              </span>
                            </div>
                          </div>
                        ))}
